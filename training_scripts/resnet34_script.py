...
class ResNet(nn.Module):
    def __init__(self, img_channels, num_layers, num_classes):
        ...
        self.convUp2 = SingleConv(256, 256, kernel_size=3)
        self.upsample3 = nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2)
        self.convUp3 = SingleConv(128, 128, kernel_size=3)
...
def main():
    ...
    model = ResNet(img_channels=1, num_layers=34, num_classes=1)
...
############################################################
    ...
    save_path = os.path.expandvars('$TMPDIR/r34_model_dn_f4.pth')
    torch.save(model.state_dict(), save_path)


    output_path = os.path.expandvars('$TMPDIR/output_r34_dn_f4.mat')
